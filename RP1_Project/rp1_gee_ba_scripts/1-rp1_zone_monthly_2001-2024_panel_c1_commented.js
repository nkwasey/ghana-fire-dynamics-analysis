...
// window January 2001 through December 2024 (START inclusive; END exclusive)
// so the fixed UNION denominator and year-specific annual denominators remain
// unchanged. The dedicated RP1 export family is then clipped to January 2001
...
//    • Requires exact annual support for every denominator year from 2001 to
//      2024 inclusive.
...
//      • The annual burnable masks for 2001–2024 are combined by pixel-wise OR
...
//
// 9) MONTHLY BURNED-AREA NUMERATOR (2001–2024)
...
// • Exported RP1 rows are clipped to 2001-01 through 2024-12, while the
//   internal analytical backbone and denominator support still span 2001-01
//   through 2024-12.
...
function validateConfig() {
  if (START !== '2001-01-01' || END !== '2025-01-01') {
    throw new Error('This overlap-era ACZ script is locked to START=2001-01-01 and END=2025-01-01.');
  }
  if (DENOM_START_YEAR !== 2001 || DENOM_END_YEAR !== 2024) {
    throw new Error('This overlap-era ACZ script is locked to DENOM_START_YEAR=2001 and DENOM_END_YEAR=2024.');
  }
...
// The analytical backbone remains wider (2001–2024), but exported RP1 rows are
// restricted to 200101 through 202412 so BA and AF outputs share one merge key.
// -----------------------------------------------------------------------------
...
// - union denominator window: 2001..2024 exact years only
