...
// spans the overlap-era window January 2012 through December 2024 (START
...
// then clipped to January 2012 through December 2024 so downstream BA/AF
...
//    • Requires exact support for every denominator year from 2012 to 2024.
...
//      • Annual burnable masks for 2012–2024 are combined by pixel-wise OR to
...
//
// 11) MONTHLY BURNED-AREA NUMERATOR (2012–2024) + NATIONAL REFERENCE DIAGNOSTIC
...
//    • The dedicated RP1 base/ext monthly exports are clipped to 201201
...
// • Exported RP1 base/ext monthly rows are clipped to 2012-01 through 2024-12.
...
exportsViewPanel.add(ui.Label({
  value: 'Selected ACZ exports queue the district bundle for the current ACZ: merger-ready base CSV, ext CSV, grouped QA by ACZ, and drop log when exclusions exist. The baseline method is fixed to LW_OR_LC17 and monthly RP1 exports are clipped to 2012-01 through 2024-12.',
...
aboutViewPanel.add(ui.Label({
  value:
    'This is the fixed-method district extractor for RP1. The analytical baseline is locked to LW_OR_LC17, exact-year MCD12Q1 denominator support, and the overlap-era window 2012-01 through 2024-12.\n\n' +
